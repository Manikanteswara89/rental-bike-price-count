...
setwd("C:/Users/Lenovo/Desktop/R pr")
...
#Check dimensions of the given dataset
dim(data)    
...
#Get number of unique values by column wise
...
########No need to perform Missing value analysis#################
...
#Hence we consider FEATURE SELECTION 
...
#we are not performing test on dateday variable for above stated reason
...
#THE DATA HERE WE GOT IS ALREADY NORMALIZED.
...
#Convert rules in readable format
